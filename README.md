...
> [Beta.13](https://github.com/RTBGG/Stackfort/releases/tag/v0.1.0-beta.13)
> is available for fresh, disposable Debian 13 `amd64` test servers only.
> Upgrades from Beta.10, Beta.11, Beta.12 or any existing installation are not supported.
...
by this command. The current script explicitly selects **`0.1.0-beta.13`**, not
latest stable. [Release assets and checksums](https://github.com/RTBGG/Stackfort/releases/tag/v0.1.0-beta.13)
...
**Beta.13 supports qualified GPT/UEFI and primary MBR/BIOS ext4 roots with GRUB.**
...
Beta.13 fixes rejection of larger valid initramfs file listings during one-shot
boot preparation. Already stopped installations are not resumable: do not reset
or retry them; see the [fix and stopped-host guidance](docs/native-installer-initrd-inventory.md).
