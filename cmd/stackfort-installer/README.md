...
[`0.1.0-beta.11` release](https://github.com/RTBGG/Stackfort/releases/tag/v0.1.0-beta.11)
...
Fresh installations only; upgrades from Beta.10 or another installed release are unsupported.
...
currently selects the explicitly pinned `0.1.0-beta.11` and supplies the native
