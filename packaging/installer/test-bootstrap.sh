...
grep -Fq 'explicitly pinned experimental release 0.1.0-beta.10' "$workspace/default.out"
make_fixture "$version"
...
grep -Fq "readonly default_version='0.1.0-beta.10'" "$bootstrap"
